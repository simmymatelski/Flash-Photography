const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-wasm_extensions-Bo5XPBeW.js","./ruffle-imports-CztXuSei.js","./ruffle_web-CmGirorG.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(_,A){var D=_.length;_.push(A);e:for(;0<D;){var Z=D-1>>>1,re=_[Z];if(0<o(re,A))_[Z]=A,_[D]=re,D=Z;else break e}}function t(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var A=_[0],D=_.pop();if(D!==A){_[0]=D;e:for(var Z=0,re=_.length,Fr=re>>>1;Z<Fr;){var In=2*(Z+1)-1,ui=_[In],Mn=In+1,Tr=_[Mn];if(0>o(ui,D))Mn<re&&0>o(Tr,ui)?(_[Z]=Tr,_[Mn]=D,Z=Mn):(_[Z]=ui,_[In]=D,Z=In);else if(Mn<re&&0>o(Tr,D))_[Z]=Tr,_[Mn]=D,Z=Mn;else break e}}return A}function o(_,A){var D=_.sortIndex-A.sortIndex;return D!==0?D:_.id-A.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var s=[],u=[],p=1,h=null,m=3,g=!1,y=!1,S=!1,L=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(_){for(var A=t(u);A!==null;){if(A.callback===null)r(u);else if(A.startTime<=_)r(u),A.sortIndex=A.expirationTime,n(s,A);else break;A=t(u)}}function v(_){if(S=!1,f(_),!y)if(t(s)!==null)y=!0,li(x);else{var A=t(u);A!==null&&si(v,A.startTime-_)}}function x(_,A){y=!1,S&&(S=!1,d(E),E=-1),g=!0;var D=m;try{for(f(A),h=t(s);h!==null&&(!(h.expirationTime>A)||_&&!O());){var Z=h.callback;if(typeof Z=="function"){h.callback=null,m=h.priorityLevel;var re=Z(h.expirationTime<=A);A=e.unstable_now(),typeof re=="function"?h.callback=re:h===t(s)&&r(s),f(A)}else r(s);h=t(s)}if(h!==null)var Fr=!0;else{var In=t(u);In!==null&&si(v,In.startTime-A),Fr=!1}return Fr}finally{h=null,m=D,g=!1}}var P=!1,z=null,E=-1,w=5,b=-1;function O(){return!(e.unstable_now()-b<w)}function Re(){if(z!==null){var _=e.unstable_now();b=_;var A=!0;try{A=z(!0,_)}finally{A?Me():(P=!1,z=null)}}else P=!1}var Me;if(typeof c=="function")Me=function(){c(Re)};else if(typeof MessageChannel<"u"){var xe=new MessageChannel,mf=xe.port2;xe.port1.onmessage=Re,Me=function(){mf.postMessage(null)}}else Me=function(){L(Re,0)};function li(_){z=_,P||(P=!0,Me())}function si(_,A){E=L(function(){_(e.unstable_now())},A)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){y||g||(y=!0,li(x))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(_){switch(m){case 1:case 2:case 3:var A=3;break;default:A=m}var D=m;m=A;try{return _()}finally{m=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,A){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var D=m;m=_;try{return A()}finally{m=D}},e.unstable_scheduleCallback=function(_,A,D){var Z=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?Z+D:Z):D=Z,_){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=D+re,_={id:p++,callback:A,priorityLevel:_,startTime:D,expirationTime:re,sortIndex:-1},D>Z?(_.sortIndex=D,n(u,_),t(s)===null&&_===t(u)&&(S?(d(E),E=-1):S=!0,si(v,D-Z))):(_.sortIndex=re,n(s,_),y||g||(y=!0,li(x))),_},e.unstable_shouldYield=O,e.unstable_wrapCallback=function(_){var A=m;return function(){var D=m;m=A;try{return _.apply(this,arguments)}finally{m=D}}}})(Uu);Wu.exports=Uu;var Nf=Wu.exports;/**
 * @license React
